...
export const stages: Stage[] = [
  {
    ...
    color: "#ec4899",
    waypoints: [
      // Официален Roadbook: Foglio firma / Signature podium — Old Town Nessebar Park.
      { name: "НЕСЕБЪР старт", totalKm: 0, toFinishKm: 147, raceTime: "13:50", closeTime: "12:20", coords: [42.660600, 27.736600] },
      // KM 0 в края на неутрализирания участък, както е отбелязано в roadbook-а.
      ...
      { name: "Бургас Сарафово", road: "I-9", totalKm: 30.0, toFinishKm: 117.0, raceTime: "14:37", closeTime: "13:07", coords: [42.557000, 27.495500] },
      ...
      { name: "Меден рудник", road: "II-99", totalKm: 44.0, toFinishKm: 103.0, raceTime: "14:55", closeTime: "13:25", coords: [42.466900, 27.476200] },
